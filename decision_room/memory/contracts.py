...
catch-all topics combining unrelated attributes. Keep only useful context, priorities, definitions, availability and
...
Use temporal_scope=unspecified only when no time restriction is stated. Use dated with explicit
