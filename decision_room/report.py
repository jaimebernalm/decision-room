...
def render(data, exported_at):
    ...
    body = [f'<header><p class="eyebrow">DECISION ROOM · INFORME</p><span class="badge {"ok" if approved else "pending"}">{e(label)}</span>',
