    ...
    if (["home", "analyses", "files", "reports", "my-business"].includes(hash))
      state.poll = setInterval(async () => {
        try {
          ...
          if (generation !== state.generation) return;
          const listPage = ["home", "analyses", "files", "reports", "my-business"].includes(hash);
