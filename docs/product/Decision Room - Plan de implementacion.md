...
**Confirmación de eliminación y centrado, 25 de septiembre de 2026:** el listado de conversaciones se centra dentro del área de contenido. La eliminación recuperable usa un diálogo de la aplicación con título del chat, consecuencias precisas y acciones de cancelar o eliminar, en lugar de la confirmación del navegador. Véanse [comprobaciones](../validation/2026-09-25-delete-dialog-check.md).
