...
**Siguiente trabajo:** paso 1.7, variedad de casos sobre el recorrido integrado. Repetir DR-001 y DR-002, variar columnas y contextos, probar correcciones y preguntas con los modelos reales y comparar otro modelo si persisten errores. Las pruebas del controlador y algunos resultados revisados no cierran la evaluación de calidad del agente.
