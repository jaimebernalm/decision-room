...
**Estado:** alcance funcional y arquitectura acordados; recorrido interno implementado hasta el paso 1.6, con evaluación semántica todavía abierta. El paso 1.7 debe comprobar variedad y repetibilidad antes de aceptar la entrega 1. La aplicación web corresponde a la entrega 2. PostgreSQL sigue siendo la opción inicial; el ejecutor usa Docker dentro de Colima local y conserva evidencia privada.  
