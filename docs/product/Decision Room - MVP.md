...
**Avance del 21 de septiembre de 2026:** implementadas y comprobadas la ingesta CSV persistente y la herramienta de Python aislado, con PostgreSQL local, archivos privados y evidencia recuperable. Los 48 CSV de WWI se probaron juntos. Continúan pendientes el agente y el informe. El detalle vigente está en el plan, [la guía de ingesta](../technical/ingestion.md) y [la guía del ejecutor](../technical/sandbox.md). Las notas de aprobación de bloques que siguen conservan su contexto de diseño del día 18.  
**Estado:** alcance funcional y arquitectura acordados. Casos de referencia, ingesta CSV con PostgreSQL/Parquet y herramienta de Python aislado implementados y comprobados el 21 de septiembre de 2026. El ejecutor usa Docker dentro de Colima local y conserva evidencia privada. Siguiente paso: 1.4, agente LangGraph con preguntas y recuperación. Modelos, agente/revisor, informe, interfaz y evaluación del producto pendientes. PostgreSQL sigue siendo la opción inicial, con posibilidad abierta de cambiar a Convex tras comprobar la integración.  
...
**Avance del 21 de septiembre de 2026:** los [tres casos CSV de referencia](../../data/reference-cases/README.md) están preparados; también están implementadas las estructuras iniciales, la ingesta persistente CSV y la ejecución aislada de Python. La prueba con las 48 tablas de WWI verificó datos, cálculos conocidos, evidencia y recuperación. El [ejecutor local](../technical/sandbox.md) usa Docker dentro de Colima, límites de recursos y resultados candidatos pendientes de revisión. Todavía no se ha implementado ni evaluado el agente.

**Siguiente paso: agente, preguntas y recuperación (1.4).** Seguir el [plan de implementación acordado](<Decision Room - Plan de implementacion.md>): conectar LangGraph con perfiles y muestras, interpretación, preguntas materiales y pausa/reanudación. La herramienta de ejecución y sus estructuras de evidencia ya están disponibles para el paso posterior de investigación autónoma.
