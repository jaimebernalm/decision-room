...
- [ ] **A. Selección y manifiesto de contexto.** Seleccionar perfil, hechos, dudas, fuentes y resultados según negocio, objetivo y periodo. Guardar identificadores/versiones utilizados, reglas de selección y límites. Empezar con referencias y filtros explícitos; no exigir búsqueda vectorial.
- [ ] **B. Integración con el recorrido actual.** Incorporar el manifiesto en planificación, investigación y revisión, manteniendo las mismas versiones relevantes. Mantener el contexto libre del objetivo actual separado de los hechos del negocio. Registrar qué fuentes y definiciones respaldan cada resultado reutilizable.
