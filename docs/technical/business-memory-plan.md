...
**Introducción gradual de búsqueda semántica:** la primera implementación de 2.5.3 construyó referencias, descripciones, contrato y búsqueda textual. Tras detectar omisiones con sinónimos, el usuario pidió añadir embeddings de OpenAI y pgvector antes de 2.5.4. Esa ampliación implementa búsqueda híbrida y cachés derivadas con comprobación de originales; véanse el [contrato](semantic-retrieval.md) y la [evaluación](../validation/2026-09-23-semantic-check.md). Los chats se evaluarán cuando se incorporen; no se vectorizan las filas tabulares.
